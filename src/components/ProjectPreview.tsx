    ...
    >
      <div className="absolute inset-0 scale-110">
        <Image
          ...
          fill
          aria-hidden
          className={`object-cover blur-2xl transition-opacity duration-500 ease-out ${backdropImageClassName}`}
          sizes="100vw"
        />
        <Image
          src={hoverImageSrc}
          ...
          fill
          aria-hidden
          className={`object-cover blur-2xl opacity-0 transition-opacity duration-500 ease-out group-hover:opacity-100 ${backdropImageClassName}`}
          sizes="100vw"
        />
        <div className={`absolute inset-0 ${backdropTintClassName}`} />
      </div>

      <div
        className={`absolute inset-0 z-10 scale-[0.75] overflow-hidden border border-4 border-white/28 ring-1 ring-inset ring-white/20 shadow-[0_12px_28px_rgba(0,0,0,0.16)] ${frameClassName}`}
      >
        <Image
          src={imageSrc}
          alt={imageAlt}
